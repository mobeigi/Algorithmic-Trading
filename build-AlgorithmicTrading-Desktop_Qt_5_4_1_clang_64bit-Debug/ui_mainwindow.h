...
public:
    ...
    QWidget *trock_simulator_tab;
    QVBoxLayout *verticalLayout_7;
    QHBoxLayout *inputCSVLayout_2;
    QVBoxLayout *verticalLayout_13;
    QSpacerItem *horizontalSpacer_2;
    QLabel *input_csv_label_2;
    QWidget *verticalWidget_3;
    QHBoxLayout *horizontalLayout_7;
    QLineEdit *tradeSimulator_input_csv_location;
    QPushButton *tradeSimulator_browseCSV;
    QLabel *input_csv_label_3;
    QComboBox *tradeSimulator_comboBox;
    QSpacerItem *verticalSpacer_2;
    QLabel *simulations_error_msg;
    QPushButton *tradeSimulatorRunSimulationButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        analysisInputCSVField = new QLineEdit(frame);
        ...
        analysisInputCSVButton = new QPushButton(frame);
...
"}"));
        ...
        horizontalLayout_6->addWidget(exportsummary);
...
"}"));
        ...
        horizontalLayout_6->addWidget(showanalysis_button);
        ...
        trock_simulator_tab = new QWidget();
        trock_simulator_tab->setObjectName(QStringLiteral("trock_simulator_tab"));
        verticalLayout_7 = new QVBoxLayout(trock_simulator_tab);
        verticalLayout_7->setSpacing(6);
        verticalLayout_7->setContentsMargins(11, 11, 11, 11);
        verticalLayout_7->setObjectName(QStringLiteral("verticalLayout_7"));
        inputCSVLayout_2 = new QHBoxLayout();
        inputCSVLayout_2->setSpacing(6);
        inputCSVLayout_2->setObjectName(QStringLiteral("inputCSVLayout_2"));
        ...
        input_csv_label_2 = new QLabel(trock_simulator_tab);
        input_csv_label_2->setObjectName(QStringLiteral("input_csv_label_2"));
        input_csv_label_2->setMaximumSize(QSize(16777215, 16777215));
        input_csv_label_2->setMargin(0);

        verticalLayout_13->addWidget(input_csv_label_2);

        verticalWidget_3 = new QWidget(trock_simulator_tab);
        verticalWidget_3->setObjectName(QStringLiteral("verticalWidget_3"));
        verticalWidget_3->setMaximumSize(QSize(16777215, 16777215));
        horizontalLayout_7 = new QHBoxLayout(verticalWidget_3);
        horizontalLayout_7->setSpacing(6);
        horizontalLayout_7->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_7->setObjectName(QStringLiteral("horizontalLayout_7"));
        tradeSimulator_input_csv_location = new QLineEdit(verticalWidget_3);
        tradeSimulator_input_csv_location->setObjectName(QStringLiteral("tradeSimulator_input_csv_location"));
        tradeSimulator_input_csv_location->setMinimumSize(QSize(0, 32));

        horizontalLayout_7->addWidget(tradeSimulator_input_csv_location);

        tradeSimulator_browseCSV = new QPushButton(verticalWidget_3);
        tradeSimulator_browseCSV->setObjectName(QStringLiteral("tradeSimulator_browseCSV"));
        tradeSimulator_browseCSV->setIcon(icon);
        tradeSimulator_browseCSV->setIconSize(QSize(32, 32));

        horizontalLayout_7->addWidget(tradeSimulator_browseCSV);


        verticalLayout_13->addWidget(verticalWidget_3);

        input_csv_label_3 = new QLabel(trock_simulator_tab);
        input_csv_label_3->setObjectName(QStringLiteral("input_csv_label_3"));
        input_csv_label_3->setMaximumSize(QSize(16777215, 20));

        verticalLayout_13->addWidget(input_csv_label_3);

        tradeSimulator_comboBox = new QComboBox(trock_simulator_tab);
        tradeSimulator_comboBox->setObjectName(QStringLiteral("tradeSimulator_comboBox"));
        tradeSimulator_comboBox->setMaxVisibleItems(16);

        verticalLayout_13->addWidget(tradeSimulator_comboBox);

        verticalSpacer_2 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_13->addItem(verticalSpacer_2);

        simulations_error_msg = new QLabel(trock_simulator_tab);
        simulations_error_msg->setObjectName(QStringLiteral("simulations_error_msg"));
        simulations_error_msg->setMaximumSize(QSize(16777215, 20));
        simulations_error_msg->setStyleSheet(QStringLiteral("color: rgb(255, 0, 0);"));

        verticalLayout_13->addWidget(simulations_error_msg);

        tradeSimulatorRunSimulationButton = new QPushButton(trock_simulator_tab);
        tradeSimulatorRunSimulationButton->setObjectName(QStringLiteral("tradeSimulatorRunSimulationButton"));
        tradeSimulatorRunSimulationButton->setFont(font2);
        tradeSimulatorRunSimulationButton->setCursor(QCursor(Qt::PointingHandCursor));
        tradeSimulatorRunSimulationButton->setStyleSheet(QLatin1String("#MainWindow QPushButton {\n"
"background: qradialgradient(cx: 0.3, cy: -0.4,\n"
"fx: 0.3, fy: -0.4,\n"
"radius: 1.35, stop: 0 #fff, stop: 1 #3498db);\n"
"border: 1px solid #555;\n"
...
"radius: 1.35, stop: 0 #fff, stop: 1 #3498db);\n"
"}"));
        tradeSimulatorRunSimulationButton->setIcon(icon2);
        tradeSimulatorRunSimulationButton->setIconSize(QSize(24, 24));
        tradeSimulatorRunSimulationButton->setAutoDefault(false);
        tradeSimulatorRunSimulationButton->setDefault(false);
        tradeSimulatorRunSimulationButton->setFlat(false);

        verticalLayout_13->addWidget(tradeSimulatorRunSimulationButton);


        inputCSVLayout_2->addLayout(verticalLayout_13);


        verticalLayout_7->addLayout(inputCSVLayout_2);

        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/resources/globe.gif"), QSize(), QIcon::Normal, QIcon::Off);
        analysis_prep->addTab(trock_simulator_tab, icon7, QString());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Input CSV</span></p></body></html>", 0));
        ...
        analysisStrategyLabel->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Strategy Module</span></p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
...
"Calculation", 0));
...
#endif // QT_NO_TOOLTIP
        saveCSVExecuteButton->setText(QApplication::translate("MainWindow", "Save as CSV", 0));
#ifndef QT_NO_TOOLTIP
        ...
        strategy_module_label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Strategy Module</span></p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
        ...
        input_csv_label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Input CSV</span></p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
        ...
        outputcsv_label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Output Order CSV File:</span></p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        exportsummary->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Export order file summary analysis to a CSV file.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        exportsummary->setText(QApplication::translate("MainWindow", "Save Summary as CSV", 0));
#ifndef QT_NO_TOOLTIP
        ...
        input_csv_label_2->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Input CSV</span></p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
        tradeSimulator_browseCSV->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Select an input CSV file you wish to use with trade simulation mode.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        tradeSimulator_browseCSV->setText(QApplication::translate("MainWindow", "Browse", 0));
        input_csv_label_3->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Select Equity to Monitor</span></p></body></html>", 0));
        simulations_error_msg->setText(QString());
#ifndef QT_NO_TOOLTIP
        tradeSimulatorRunSimulationButton->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Run trade simulation mode to simulate live trading.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        tradeSimulatorRunSimulationButton->setText(QApplication::translate("MainWindow", "Run Simulation", 0));
        analysis_prep->setTabText(analysis_prep->indexOf(trock_simulator_tab), QApplication::translate("MainWindow", "Trade Simulator", 0));
        logo->setText(QString());
        companylabel->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\">Trock Pty Ltd. Version v2.0 (build 218). <span style=\" font-weight:600;\">Web</span>: <a href=\"http://www.trock.net/\"><span style=\" text-decoration: underline; color:#0000ff;\">http://www.trock.net/</span></a></p></body></html>", 0));
    } // retranslateUi

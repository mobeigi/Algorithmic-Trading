/****************************************************************************
** Meta object code from reading C++ file 'MyTabWindow.h'
**
...
#include "../Trading_Platform_GUI/MyTabWindow.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MyTabWindow.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyTabWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 5) // "index"
    ...
    "MyTabWidget\0currentChangedSlot\0\0index"
};
...
void *MyTabWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyTabWidget.stringdata))

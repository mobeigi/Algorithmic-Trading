...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        inpu_csv_label = new QLabel(verticalLayoutWidget);
        inpu_csv_label->setObjectName(QStringLiteral("inpu_csv_label"));

        programLayout->addWidget(inpu_csv_label);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "Parameters", 0));
